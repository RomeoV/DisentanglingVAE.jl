...
import Metalhead
import Flux: cpu
import FastAI: mapobs, taskdataloaders, ObsView, datarecipes, load
import StaticArrays: SVector
import Random

# import Flux.MLUtils: _default_executor
# import MLUtils.Transducers: ThreadedEx

function eval_linear_model()
